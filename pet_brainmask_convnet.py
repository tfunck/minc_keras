...
if __name__ == '__main__':
    ...
    pet_brainmask_convnet(args.source_dir, args.target_dir, input_str=args.input_str, label_str=args.label_str, ratios=args.ratios, batch_size=args.batch_size, nb_epoch=args.nb_epoch, clobber=args.clobber, model_name = args.model_name ,images_to_predict= args.images_to_predict, onehot_label=args.onehot_label, verbose=args.verbose)
